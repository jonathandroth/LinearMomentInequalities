...
%We do the calibration with Eta_t = 0 to match what we did before we added
%this in (kind of ad hoc)
...
save('../../Output/Simulated_Data/calibrated_params', 'sigma_nu', 'sigma_eps', 'sigma_zeta', 'mu_f');
...
save('../../Output/Simulated_Data/Calibrated_SigmaZeta/all_simulation_params',...
